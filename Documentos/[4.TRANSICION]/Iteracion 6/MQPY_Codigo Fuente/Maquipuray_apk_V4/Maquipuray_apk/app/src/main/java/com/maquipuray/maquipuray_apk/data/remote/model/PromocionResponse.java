...
public class PromocionResponse implements Serializable {
    ...
    private String fechaValidaPromocion;

    private int imageResource;

    public String getFechaValidaPromocion() {
        return fechaValidaPromocion;
    }

    public void setFechaValidaPromocion(String fechaValidaPromocion) {
        this.fechaValidaPromocion = fechaValidaPromocion;
    }

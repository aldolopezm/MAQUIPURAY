package com.maquipuray.maquipuray_apk_transporte.ui.main.register;
    ...
    public void onClick(View view) {
        if (view.getId() == R.id.sign_up) {
            ...
            if (firstname.getText().toString().equals(""))
                ...
                passwordTil.setError("Complete su passowrd !");
...
//                retypePasswordTil.setError("Complete su Password !");
                ...
                emailTil.setError("Email address not valid!");
...
//                retypePasswordTil.setError("Your passwords don't match!");
                ...
                contactTil.setError("Complete su telefono. !");
